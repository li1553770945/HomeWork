...
class HomeWorkInfModel(models.Model):
    ...
    type=models.CharField(max_length=100,choices=(('file',"文件"),('hypertext',"超文本")),default="hypertext",verbose_name="作业类型")
    ...
    member_can_know_donelist = models.BooleanField(verbose_name="成员可查看完成情况", choices=((False, "否"), (True, "是")),default=False)
